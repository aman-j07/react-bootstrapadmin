  ...
  return (
     <aside className="sidebar bluetxt p-4 bg-white" ref={props.sidebarRef}>
          <ul className="list-unstyled">
            <li className="d-flex gap-2 p-2 my-1 text-decoration-none" role="button">
            ...
            <li>
              <div className="accordion-item border-0">
                <h2 className="accordion-header" id="panelsStayOpen-headingOne">
                  <button className="accordion-button px-2 bluetxt sidebar__links collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#components" aria-expanded="true" aria-controls="components">
                ...
                <div id="components" className="accordion-collapse collapse" aria-labelledby="panelsStayOpen-headingOne">
                  ...
                  {components.map(ele=>{
                      return <li className="d-flex align-items-center gap-2 p-2 text-decoration-none shorttxt">
            ...
            <div className="accordion-item border-0">
                <h2 className="accordion-header" id="panelsStayOpen-headingOne">
                  <button className="accordion-button px-2 bluetxt sidebar__links collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#forms" aria-expanded="true" aria-controls="forms">
            ...
            <div className="accordion-item border-0">
                <h2 className="accordion-header" id="panelsStayOpen-headingOne">
                  <button className="accordion-button px-2 bluetxt sidebar__links collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#tables" aria-expanded="true" aria-controls="tables">
            ...
            <div className="accordion-item border-0">
                <h2 className="accordion-header" id="panelsStayOpen-headingOne">
                  <button className="accordion-button px-2 bluetxt sidebar__links collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#charts" aria-expanded="true" aria-controls="charts">
            ...
            <div className="accordion-item border-0">
                <h2 className="accordion-header" id="panelsStayOpen-headingOne">
                  <button className="accordion-button px-2 bluetxt sidebar__links collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#icons" aria-expanded="true" aria-controls="icons">
            ...
            <li  className="d-flex gap-2 p-2  my-1 text-decoration-none">
